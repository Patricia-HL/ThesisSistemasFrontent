...
import SupervisorAccountIcon from "@mui/icons-material/SupervisorAccount"; // Icono para Roles
import SecurityIcon from "@mui/icons-material/Security"; // Icono para Administrador
...
const privateRoutes = [
  ...
  },
  {
    ...
    columns: 1,
    rowsPerColumn: 2,
    roles: ["Lider", "Gerente", "Administrador"],
    collapse: [
      {
        name: "Registrar",
        route: "/register-pegs",
